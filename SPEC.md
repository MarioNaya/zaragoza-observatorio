...
Versión 0.10 · 7 de septiembre de 2026 · Documento de arranque para trabajar con Claude Code. Revisado con los resultados de los spikes S0.1–S0.6 y S1.1–S1.3 (`docs/spikes/`), con las ADR-001 a ADR-009 (`docs/decisions/`), con la implementación completa de la fase 1 (`ingestion` y `catalog` con los dos ejes de frescura, el inventario de endpoints del Swagger y la federación en datos.gob.es) y con la **instancia ya desplegada y su coste acotado** (ADR-008, ADR-009, `docs/despliegue.md`). Estado del proyecto y arranque de sesión: `docs/ESTADO.md`. Diagramas: `docs/arquitectura.md`.
