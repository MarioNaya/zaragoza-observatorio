...
Las reglas 16 a 29 (spikes como tests JUnit, stack real, comportamiento verificado de la API municipal, unidad territorial, contexto `spending`, infraestructura de la fase 1, datos personales en fixtures, eje observado, inventario de la API, federación, despliegue, memoria y coste, copias de seguridad y resolución territorial) derivan de las ADR y de los spikes y viven solo en `CLAUDE.md`.
