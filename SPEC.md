...
- Módulo `geo` (shared kernel): juntas municipales y vecinales (29) con geometría y las dos numeraciones, secciones censales (491) opcionales, padrón por junta y año (2020, 2021, 2022 y 2024: falta 2023), resolución punto → junta con los tres estados `resuelto`/`fuera`/`sin punto` (S0.4, S2.1: no existen barrios como dato abierto).
