...
9. **Nada se ajusta por cobertura.** Ni en este eje ni en ningún otro. Un ajuste supondría que lo no geolocalizado se reparte como lo geolocalizado, y eso **no está comprobado**; sería exactamente la clase de conclusión que la regla 6 prohíbe al producto. Lo que se da son las columnas para que quien quiera hacerlo lo haga y responda de ello.
10. **El eje territorial sigue agrupando solo lo que tiene junta**, y la respuesta sigue trayendo `unassigned` y el reparto por `assignment` (regla 7, ADR-011 §7). El cruce no cambia esa frontera: la añade una dimensión.
