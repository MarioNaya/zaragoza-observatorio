...
flowchart LR
  ...
  FRONT["<b>frontend/</b> — la aplicación (ADR-020, ADR-021, ADR-022)<br/>Angular 21 zoneless · sitio estático en <b>otro dominio</b><br/><b>siete secciones</b> con explorador de registros, series y rankings<br/>mapa y gráficos en SVG a mano, sin librería ni teselas<br/>ordena y pagina el backend, pinta el navegador<br/>fronteras, contrato de tipos y barrido <b>como tests</b>"]
