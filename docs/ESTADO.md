...
5. **Primer despliegue con migración nueva**: `main` se despliega solo (tres redespliegues comprobados: dos el 2026-09-07 y el de documentación del 2026-09-08, todos con los datos intactos), pero todavía no se ha desplegado un cambio que traiga una migración Flyway. Con `ddl-auto=validate`, un fallo de ese tipo aborta el arranque, no se manifiesta en caliente: conviene estar delante la primera vez.
