...
docs/arquitectura.md            diagramas Mermaid (flujo de datos, módulos, hexagonal)
docs/arquitectura.html          la misma arquitectura como página HTML autónoma (SVG); publicada en:
